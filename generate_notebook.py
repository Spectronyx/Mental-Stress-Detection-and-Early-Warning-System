...
def create_notebook():
    ...
    # --- 7. UNSUPERVISED ---
    add_markdown("## Section 7: Unsupervised Clustering (K-Means)")
    add_code([
    ...
    # --- 16. LSTM ---
    add_markdown("### Deep Learning (LSTM)")
    add_code([
    ...
    # --- 17. INTERACTIVE PROMPT ---
    add_markdown("## Section 17: Interactive Mental Health Analysis Prompt")
    add_code([
        "def analyze_my_text():\n",
    ...
    with open('mental_health_analysis.ipynb', 'w') as f:
        json.dump(notebook, f, indent=2)

if __name__ == "__main__":
    create_notebook()
    print("Expanded notebook generated successfully.")
